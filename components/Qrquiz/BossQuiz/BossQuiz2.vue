  ...
  <div class="boss-quiz">
    ...
    <div class="boss-content">
      <div class="quiz-content pt-0">
        <p class="gray-box">멀리서 악마가 흥얼거리는 소리가 들린다.<br>이 못된 녀석... 우리를 비웃는건지... 노래를 계속 들어보니 뭔가를 얘기하는 것 같은데...?</p>
      </div>
      <img src="~/assets/images/games/qr/boss/theme-5/quiz2.jpg" alt="" class="quiz-img">
      정답은 'foolish'입니다.
    </div>
    ...
    >
      <div class="wrap-hint">
        ...
        >
          ...
          >
            <div class="hint-content open">
              <img src="~/assets/images/games/qr/boss/theme-5/hint2-1.jpg" alt="" class="hint-img">
              <div class="hint-message"><span class="red">무지개 색의 순서</span>가 뭐였더라...?</div>
            </div>
        ...
        >
          ...
          >
            <div class="hint-content open">
              <img src="~/assets/images/games/qr/boss/theme-5/hint2-2.jpg" alt="" class="hint-img">
              <div class="hint-message">무지개색상의 순서대로<br>알파벳을 적어보자.</div>
            </div>
            <div class="hint-footer justify-content-center">
              <button
                type="button"
    ...
    >
      ...
      >
        ...
        <div class="box-answer">
          <p class="modal-text font-weight-bold">foolish</p>
        </div>
        <p class="box-message">바보같다고??<br>절대 가만두지 않겠어!</p>
        <div class="box-btn">
          <button
            type="button"
            class="btn-push"
...
const handleClickSubmit = () =>{
  ...
  if(inputtedAnswer.value === 'foolish') {
